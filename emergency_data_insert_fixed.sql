...
-- 4. 逐条插入毕业去向数据（避免VALUES长度问题）
SELECT '插入毕业去向数据...' as status;

-- 第一条：2021001 - 就业
INSERT INTO graduation_destinations (
    student_id, destination_type, company_name, position, salary, work_location,
    school_name, major, degree, abroad_country, startup_name, startup_role,
    other_description, status, submit_time, created_at, updated_at
) VALUES (
    (SELECT id FROM student_profiles WHERE student_number = '2021001' LIMIT 1),
    'employment', '腾讯科技有限公司', '前端开发工程师', 15000, '深圳市南山区',
    NULL, NULL, NULL, NULL, NULL, NULL,
    NULL, 'pending', NOW(), NOW(), NOW()
);
...
INSERT INTO graduation_destinations (
    ...
    'employment', '阿里巴巴（中国）有限公司', 'Java开发工程师', 18000, '杭州市余杭区',
    NULL, NULL, NULL, NULL, NULL, NULL,
    NULL, 'pending', NOW(), NOW(), NOW()
);
...
INSERT INTO graduation_destinations (
    ...
    'furtherstudy', NULL, NULL, NULL, NULL,
    '清华大学', '计算机应用技术', '硕士研究生', NULL, NULL, NULL,
    NULL, 'pending', NOW(), NOW(), NOW()
);
...
INSERT INTO graduation_destinations (
    ...
    'abroad', NULL, NULL, NULL, NULL,
    '美国斯坦福大学', '人工智能', '博士研究生', '美国', NULL, NULL,
    NULL, 'pending', NOW(), NOW(), NOW()
);
...
INSERT INTO graduation_destinations (
    ...
    NULL, NULL, NULL, NULL, '北京创新科技有限公司', '创始人兼CEO',
    NULL, 'pending', NOW(), NOW(), NOW()
);
...
INSERT INTO graduation_import_batches (
    ...
    '手动插入测试数据',
    'emergency_data_insert_fixed.sql',
    5,
    5,
    0,
    'completed',

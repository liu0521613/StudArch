...
-- 3. 插入测试用户数据（使用UUID格式的ID）
INSERT INTO users (id, username, email, user_number, full_name, role_id, status, phone, department, grade, class_name) VALUES
-- 学生用户（使用UUID格式）
('11111111-1111-1111-1111-111111111111', 'student_2021001', 'student_2021001@example.com', '2021001', '李小明', '3', 'active', '13800138000', '计算机学院', '2021级', '计算机科学与技术1班'),
('11111111-1111-1111-1111-111111111112', 'student_2021002', 'student_2021002@example.com', '2021002', '王小红', '3', 'active', '13800138001', '计算机学院', '2021级', '计算机科学与技术1班'),
('11111111-1111-1111-1111-111111111113', 'student_2021003', 'student_2021003@example.com', '2021003', '张伟', '3', 'active', '13800138002', '软件学院', '2021级', '软件工程1班'),
-- 教师用户（使用UUID格式）
('11111111-1111-1111-1111-111111111121', 'teacher_zhang', 'teacher_zhang@example.com', 'T001', '张老师', '2', 'active', '13800138003', '计算机学院', NULL, NULL),
('11111111-1111-1111-1111-111111111122', 'teacher_wang', 'teacher_wang@example.com', 'T002', '王老师', '2', 'active', '13800138004', '软件学院', NULL, NULL),
-- 管理员用户（使用UUID格式）
('11111111-1111-1111-1111-111111111131', 'admin', 'admin@example.com', 'A001', '系统管理员', '1', 'active', '13800138005', NULL, NULL, NULL)
